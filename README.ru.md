...
- **Панель истории**: быстро копируйте недавние скриншоты, цвета и ссылки, а также добавляйте элементы в избранное через звезду при наведении.
- **OCR и перевод на устройстве**: Apple Vision локально распознаёт текст на изображениях, а в macOS 15 и новее Apple Translation переводит его на устройстве. Собственные ИИ-сервисы и DeepL по-прежнему доступны.
- **Загрузка на свой хостинг**: поддерживаются Tencent COS, Qiniu Kodo и Aliyun OSS. Учетные данные остаются на вашем Mac.
- **Нативный интерфейс AppKit**: без Electron и телеметрии.

## Скриншоты

<table>
<tr>
  <td colspan="2" align="center"><img src="images/window-snap.png" alt="Smart window detection" /><br/><sub><b>Снимок окна в один клик</b><br/>capcap сам находит границы окна.</sub></td>
</tr>
<tr>
...
В настройках можно выбрать язык, значок строки меню, запуск при входе, шорткаты, размер истории, хостинг изображений и быстрые переходы к системным разрешениям. Область выделения и редактор по умолчанию видны во внешних записях экрана без дополнительной настройки. Интерфейс поддерживает 简体中文, 繁體中文, English, 日本語, 한국어, Français, Русский и Tiếng Việt.
