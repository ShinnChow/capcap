...
- **最近歷程**：歷史面板集中顯示截圖、錄影、取色和文字記錄，支援分類、搜尋與快速再次複製；快取數量可設定。
...
歷史面板會讀取儲存在 `~/Library/Application Support/capcap/History` 的最近截圖、錄影、取色和文字記錄。點擊項目可重新複製，面板內還可分類篩選、搜尋、預覽、刪除選取項目或全部歷史，並在 Finder 中開啟快取目錄。
